        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3.5 mt-2">
              <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" className="p-2 bg-brand-primary/10 hover:bg-brand-secondary text-brand-cream rounded-full transition-all hover:scale-110" aria-label="Instagram">
              ...
              <a href={settings.facebookUrl} target="_blank" rel="noopener noreferrer" className="p-2 bg-brand-primary/10 hover:bg-brand-secondary text-brand-cream rounded-full transition-all hover:scale-110" aria-label="Facebook">
                <svg className="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                </svg>
              </a>
              <a href={settings.youtubeUrl} target="_blank" rel="noopener noreferrer" className="p-2 bg-brand-primary/10 hover:bg-brand-secondary text-brand-cream rounded-full transition-all hover:scale-110" aria-label="YouTube">
                <svg className="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
