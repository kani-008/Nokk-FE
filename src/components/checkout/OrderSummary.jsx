    ...
    <>
      ...
      <div className="md:flex md:items-start md:gap-6 pb-28 md:pb-0">
        ...
        <div className="space-y-4 md:space-y-5 md:flex-1 md:min-w-0">
          ...
          <div className="card p-4 sm:p-5 max-w-7xl mx-auto w-full">
      ...
      <div className="hidden md:block mt-8 text-center border-t border-amber-100 pt-4">
        <p className="font-body text-[11px] text-amber-500 leading-relaxed max-w-2xl mx-auto">
          By continuing with the order, you confirm that you agree to Namma Oor Karuvattu Kadai's{" "}
